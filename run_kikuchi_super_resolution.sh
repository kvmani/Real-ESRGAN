...
#CUDA_VISIBLE_DEVICES=0,1,2,3 \
python -m torch.distributed.launch --nproc_per_node=4 --master_port=$MASTER_PORT ../realesrgan/train.py -opt ../options/train_kikuchi_realesrnet_x4plus.yml --launcher pytorch 
